...
function deepClone(obj, hash = new WeakMap()) {
  ...
  const result = obj instanceof Set ? new Set(obj) // objects contained in sets are NOT cloned
  : obj instanceof Map ? new Map(Array.from(obj, ([key, val]) => [key, deepClone(val, hash)])) : obj instanceof Date ? new Date(obj) : obj instanceof RegExp ? new RegExp(obj.source, obj.flags) // ... add here any specific treatment for other classes ...
