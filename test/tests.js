...
import registerUtils from './suites/utils.test.js';
...
import registerHandles from './suites/handles.test.js';
import registerScheduler from './suites/scheduler.test.js';
import registerEmitScheduling from './suites/emit-scheduling.test.js';
...
registerHandles(runner);
registerScheduler(runner);
registerEmitScheduling(runner);
